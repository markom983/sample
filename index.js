...
<style>
    ...
    <body>
      <div style="display:flex; flex-direction: column; margin: 0; padding: 0">
        ...
        <span style="display: block}">Auto Servis</span>
        <span>sample text}</span>
        <img id='barcode' src="https://api.qrserver.com/v1/create-qr-code/?data=${value}&amp;size=100x100" width=${imgDimension} height=${imgDimension} />
      </div>
    </body>
  </html>`
